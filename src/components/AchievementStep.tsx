              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 sm:space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 sm:space-y-5 md:space-y-6">
                  {fields.map((field, index) => (
                    ...
                    >
                      {/* Achievement Icon */}
                      <div className="absolute -top-3 sm:-top-4 -left-3 sm:-left-4 w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform">
                        <Trophy size={16} className="sm:size-[20px]" />
                      </div>
                  ...
                  >
                    ...
                    <span className="font-bold text-xs sm:text-sm">Add another achievement</span>
                  </button>
                </div>
